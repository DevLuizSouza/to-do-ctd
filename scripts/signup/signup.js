...
(function(){
    ...
    function caracterLength() {
        if (getPassword.value.length >= 6 && getPassword.value.length <= 8) {
            //style: common .true-requirement
            document.querySelector('.length').classList.add("true-requirement");
    
    
        } else {
            document.querySelector('.length').classList.remove("true-requirement");
    ...
    function lowerCase() {
        ...
        if (regex.test(getPassword.value)) {
            //style: common .true-requirement
            document.querySelector('.lowercase').classList.add("true-requirement");
    
    
        } else {
            document.querySelector('.lowercase').classList.remove("true-requirement");
            botaoCriarConta.setAttribute('disabled', true);
    ...
    function numberValidation() {
        ...
        if (regex.test(getPassword.value)) {
            //style: common .true-requirement
            document.querySelector('.number').classList.add("true-requirement");
    
        } else {
            document.querySelector('.number').classList.remove("true-requirement");
            botaoCriarConta.setAttribute('disabled', true);
    ...
    function upperCase() {
        ...
        if (regex.test(getPassword.value)) {
            ...
            document.querySelector('.uppercase').classList.add("true-requirement");
    
        } else {
            document.querySelector('.uppercase').classList.remove("true-requirement");
            botaoCriarConta.setAttribute('disabled', true);
        }
    }
    ...
    function specialText() {
        ...
        if (regex.test(getPassword.value)) {
            //style: common .true-requirement
            document.querySelector('.special').classList.add("true-requirement");
    
        } else {
                document.querySelector('.special').classList.remove("true-requirement");
            botaoCriarConta.setAttribute('disabled', true);
        }
    }
